...
namespace Learun.DataBase.Repository
{
    ...
    public interface IRepository
    {
        ...
        /// <param name="strSql">SQL语句</param>
        /// <returns></returns>
        T FindMG<T>(string clcName, string time_stamp) where T : class;
        /// <summary>
        /// Mongo查询列表(分页)
        /// </summary>
        /// <typeparam name="T">类型</typeparam>
        /// <param name="strSql">SQL语句</param>
        /// <returns></returns>
        T FindMG<T>(String clcName, JObject queryParam) where T : class;
        /// <summary>
        /// 查询设备信息
        /// </summary>
        /// <typeparam name="T">类型</typeparam>
        ...
        /// <returns></returns>
        List<BsonDocument> FindMGList<T>(string clcName, JObject queryParam) where T : class;
        T FindMGStateList<T>(string clcName, JObject queryParam) where T : class;
        List<BsonDocument> FindMGList<T>(string clcName) where T : class;
        T FindMGinfo<T>(string clcName, JObject queryParam) where T : class;
        //T FindMGAscFirst<T>(string clcName, JObject queryParam) where T : class;
        ...
        /// <param name="pagination">分页数据</param>
        /// <returns></returns>
        IEnumerable<T> FindMGList<T>(String clcName, JObject queryParam, Pagination pagination, string timestamp) where T : class;
        #endregion
