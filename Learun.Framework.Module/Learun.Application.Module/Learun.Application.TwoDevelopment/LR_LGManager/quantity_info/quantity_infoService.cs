...
namespace Learun.Application.TwoDevelopment.LR_LGManager
{
    ...
    /// 描 述：质量问题上报
    /// </summary>
    public class quantity_infoService : RepositoryFactory
    {
        #region  获取数据
        ...
        /// <returns></returns>
        public IEnumerable<tb_quantity_infoEntity> GetPageList(Pagination pagination, string queryJson)
        {
            try
            {
                ...
                t.product_time
                ");
                strSql.Append("  FROM tb_quantity_info t ");
                ...
                if (!queryParam["StartTime"].IsEmpty() && !queryParam["EndTime"].IsEmpty())
                {
                    ...
                    strSql.Append(" AND ( t.product_time >= @startTime AND t.product_time <= @endTime ) ");
                }
                if (!queryParam["group_no"].IsEmpty())
                {
        ...
        /// <summary>
        /// 获取tb_quantity_info表实体数据
        /// <param name="keyValue">主键</param>
        /// <summary>
        /// <returns></returns>
        public tb_quantity_infoEntity Gettb_quantity_infoEntity(string keyValue)
        {
            try
            {
        ...
        /// <summary>
        /// <returns></returns>
        public void SaveEntity(string keyValue, tb_quantity_infoEntity entity)
        {
            try
            {
